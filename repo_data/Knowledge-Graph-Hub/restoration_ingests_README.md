...
| [Documentation](https://Knowledge-Graph-Hub.github.io/restoration_ingests) |
...
Download the data for the restoration_ingests transform:

```bash
poetry run restoration_ingests download
```

To run the Koza transform for restoration_ingests:

```bash
poetry run restoration_ingests transform
```

To see available options:

```bash
poetry run restoration_ingests download --help
# or
poetry run restoration_ingests transform --help
```
