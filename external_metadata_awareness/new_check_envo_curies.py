...
For each document whose "prefix" field (case-insensitive) is one of ENVO, UBERON, or PO, this script:
  - Normalizes the stored CURIE (in the "curie_lc" field) so that the prefix is upper-case.
