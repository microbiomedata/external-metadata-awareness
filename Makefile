...
local/env-local-scale-candidates.txt:
	$(RUN) runoak --input sqlite:obo:envo info .desc//p=i 'material entity' .not [ .desc//p=i 'biome' .or .desc//p=i 'environmental material' .or 'l~brackish' .or 'l~gaseous' .or 'l~marine' .or 'l~saline' .or 'l~undersea' .or .desc//p=BFO:0000050 'environmental monitoring area' .or .desc//p=BFO:0000050 'ice' .or .desc//p=BFO:0000050 'marine environmental zone' .or 'sea floor' .or .desc//p=i 'administrative region' .or .desc//p=i 'aeroform' .or .desc//p=i 'anatomical entity environment' .or .desc//p=i 'anatomical entity' .or .desc//p=i 'area protected according to IUCN guidelines' .or .desc//p=i 'astronomical body' .or .desc//p=i 'astronomical object'  .or .desc//p=i 'building part'  .or .desc//p=i 'channel of a watercourse' .or .desc//p=i 'chemical entity' .or .desc//p=i 'cloud' .or .desc//p=i 'collection of organisms' .or .desc//p=i 'cryospheric layer' .or .desc//p=i 'ecosystem' .or .desc//p=i 'ecozone' .or .desc//p=i 'environmental system' .or .desc//p=i 'environmental zone' .or .desc//p=i 'fluid layer' .or .desc//p=i 'healthcare facility' .or .desc//p=i 'interface layer' .or .desc//p=i 'manufactured product' .or .desc//p=i 'gas planet'  .or .desc//p=i 'piece of rock'  .or .desc//p=i 'meteorite'  .or .desc//p=i 'mass of fluid'  .or .desc//p=i 'mass of biological material'  .or .desc//p=i 'organic object'  .or .desc//p=i 'material isosurface' .or .desc//p=i 'meteor' .or .desc//p=i 'observing system' .or .desc//p=i 'organism' .or .desc//p=i 'particle' .or .desc//p=i   'piece of plastic' .or .desc//p=i 'planetary structural layer' .or .desc//p=i 'plant anatomical entity' .or .desc//p=i 'political entity' .or .desc//p=i 'protected area'  .or .desc//p=i 'subatomic particle' .or .desc//p=i 'transport feature' .or .desc//p=i 'water current' .or .desc//p=i NCBITaxon:1 ] .or bridge .or road .or 'wildlife management area' > $@

local/env-local-scale-candidates-relationships.tsv:
	$(RUN) runoak --input sqlite:obo:envo relationships .desc//p=i 'material entity' .not [ .desc//p=i 'biome' .or .desc//p=i 'environmental material'  .or .desc//p=i 'chemical entity' .or .desc//p=i 'organic material' .or .desc//p=i 'anatomical entity' .or .desc//p=i 'organism'  .or .desc//p=i 'plant anatomical entity'  .or .desc//p=i 'healthcare facility'  .or .desc//p=i 'fluid layer'  .or .desc//p=i 'interface layer'  .or .desc//p=i 'manufactured product'  .or .desc//p=i 'anatomical entity environment'  .or .desc//p=i 'ecosystem'  .or .desc//p=i 'area protected according to IUCN guidelines'  .or .desc//p=i 'astronomical body'  .or .desc//p=i 'astronomical object'  .or .desc//p=i 'cloud'  .or .desc//p=i 'collection of organisms'  .or .desc//p=i 'environmental system'  .or .desc//p=i 'ecozone'  .or .desc//p=i 'environmental zone'  .or .desc//p=i 'water current'  .or .desc//p=i 'mass of environmental material'  .or .desc//p=i 'subatomic particle'  .or .desc//p=i 'observing system'  .or .desc//p=i 'particle'  .or .desc//p=i 'planetary structural layer'  .or .desc//p=i 'political entity'  .or .desc//p=i 'meteor'  .or .desc//p=i 'room'  .or .desc//p=i 'transport feature'  .or .desc//p=i 'mass of liquid'  .or .desc//p=RO:0001025 'water body'  .or .desc//p=BFO:0000050 'environmental monitoring area'  .or .desc//p=BFO:0000050 'marine littoral zone'  .or .desc//p=BFO:0000050 'marine environmental zone'  .or .desc//p=RO:0002473 'sea floor'  .or .desc//p=BFO:0000050 'saline water'  .or .desc//p=BFO:0000050 'ice'  .or .desc//p=RO:0001025 'water body'  .or .desc//p=i 'administrative region'  .or .desc//p=i 'protected area'  .or .desc//p=i 'channel of a watercourse'  .or .desc//p=i 'cryospheric layer'  .or 'l~gaseous'  .or 'l~marine'  .or .desc//p=i 'material isosurface'  .or 'l~undersea'  .or .desc//p=i NCBITaxon:1  .or 'l~saline'  .or 'l~brackish'  .or .desc//p=i 'aeroform' ] > $@
